...
*/
  carro.addPessoasNoCarro = function(x){
	if ((carro.quantidadeDePessoas + x) <= carro.assentos){
		...
		var pessoasQueRestam = carro.assentos - carro.quantidadeDePessoas;
		var pessoa = pessoasQueRestam === 1 ? " pessoa!" : " pessoas!" ;
		return "Só cabem mais " + pessoasQueRestam + pessoa;
	 } else if(carro.quantidadeDePessoas === carro.assentos) {
...
// Adicione mais 4 pessoas no carro.
  carro.addPessoasNoCarro(4) //Só cabem mais 3 pessoas no carro
...
// Adicione 10 pessoas no carro.
  carro.addPessoasNoCarro(10) //Só cabem mais 4 pessoas no carro!
